...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/teacher/teacher_course.css">
</head>
<body>
            ...
            <div class="info-block">
                ...
                %>
                    <div class="enroll-block">
                        <form action="${pageContext.request.contextPath}/enroll?course_id=<%=course.getId()%>" method="post">
